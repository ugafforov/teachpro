...
// This is a secret master password, hidden from code and only known to you
...
const AuthPage: React.FC = () => {
  ...
  if (step === 'password') {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white border border-gray-200 shadow-lg rounded-2xl p-8 animate-fade-in">
          ...
          <form onSubmit={handleMasterPasswordSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-xl py-2.5">
              Platformaga kirish
            </Button>
          </form>
        </Card>
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <Card className="w-full max-w-lg bg-white border border-gray-200 shadow-lg rounded-2xl p-8 animate-slide-up">
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-blue-500 rounded-2xl flex items-center justify-center mb-4">
        ...
        <form onSubmit={authMode === 'signin' ? handleSignIn : handleSignUp} className="space-y-4">
          ...
          <Button type="submit" disabled={loading} className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-xl py-2.5">
            {loading ? (
