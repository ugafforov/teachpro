...
const StudentImport: React.FC<StudentImportProps> = ({
  teacherId,
  groupName,
  onImportComplete,
  availableGroups = [],
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${count} ta o'quvchi qo'shildi`,
      });
      setImportText("");
      setIsOpen(false);
      onImportComplete();
          ...
          <Card className="p-4 bg-blue-50 dark:bg-blue-500/20 border-blue-200 dark:border-blue-500/40">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <code className="block bg-background dark:bg-muted p-2 rounded text-xs border border-border text-foreground">
                  Ali Valiyev
                  <br />
                  Olima Karimova
                  <br />
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {joinDate ? (
                      format(parseISO(joinDate), "d-MMM, yy", { locale: uz })
                    ) : (
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date) =>
                      date && setJoinDate(format(date, "yyyy-MM-dd"))
                    }
                    initialFocus
                    locale={uz}
                  />
